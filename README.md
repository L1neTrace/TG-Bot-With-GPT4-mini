...
В  *response* вы можете указать модель `GPT` от бесплатной до платной

---

## 🎯 Назначение проекта

Проект создан для **обучения** и может служить **готовой заготовкой** для создания бота с бесплатной моделью GPT.

---
## 🔄 ОБНОВЛЕНИЕ РЕПОЗИТОРИЯ!
## `DefaultCode` Добавлен код с обычным Api запросом
## `pip install pyinstalle` библиотека для компилирования кода в exe                                           
чтоб скомпилировать `*pyinstaller filename.py*`
---
